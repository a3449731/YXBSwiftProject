#
#  Be sure to run `pod spec lint AgoraWhiteBoard.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "SRS"
  # spec.authors            = { "SRS" => "sirusheng@agora.io" }
  # spec.social_media_url   = "https://twitter.com/SRS"
