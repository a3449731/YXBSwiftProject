...
- (void)play {
    ...
    if ([self.videoReplayService hasEnoughBuffer]) {
        ...
        [AgoraLogManager logMessage:@"play directly" level:AgoraLogLevelInfo];
...
- (void)seekToTime:(CMTime)time completionHandler:(void (^)(BOOL finished))handler {
    ...
    NSString *logString = [NSString stringWithFormat:@"seekTime: %f", seekTime];
...
- (void)videoReplayStartBuffering {
    ...
    [AgoraLogManager logMessage:@"startNativeBuffering" level:AgoraLogLevelInfo];
...
- (void)videoReplayEndBuffering {
    ...
    NSString *logString = [NSString stringWithFormat:@"videoReplayEndBuffering isBuffering:%d, pauseReason:%lu", isBuffering, (unsigned long)self.pauseReason];
    [AgoraLogManager logMessage:logString level:AgoraLogLevelInfo];
...
- (void)whiteReplayerEndBuffering {
    ...
    NSString *logString = [NSString stringWithFormat:@"whiteReplayerEndBuffering isBuffering:%d, pauseReason:%lu", isBuffering, (unsigned long)self.pauseReason];
    [AgoraLogManager logMessage:logString level:AgoraLogLevelInfo];
