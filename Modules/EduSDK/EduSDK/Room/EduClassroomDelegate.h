...
- (void)classroom:(EduClassroom *)classroom remoteUsersLeft:(NSArray<EduUserEvent*> *)events;
...
- (void)classroom:(EduClassroom *)classroom remoteUserPropertyUpdated:(EduUser *)user cause:(NSDictionary * _Nullable)cause;
