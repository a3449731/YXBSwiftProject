...
//发送消息
- (void)didSendMessage:(V2TIMMessage *)msg;
@end
@interface TUIBaseChatViewController : UIViewController
@property (nonatomic, weak) id<TUIBaseChatViewControllerDelegate> delegate;
...
@property (nonatomic, strong) UIView *biaoQingView;  //表情
@property(nonatomic,assign)BOOL haveDazhaohu;  //判断有没有打招呼

/** <#注释#> */
@property (nonatomic, copy) void (^optionBlock)(NSInteger option);
