...
+ (void)load {
    customMessageInfo = @[@{BussinessID : BussinessID_TextLink,
                          ...
                          @{BussinessID : @"custom_message_dongtai",  // 自定义消息唯一标识（注意不要重复）
                            TMessageCell_Name :  @"MSMesDongTaiCell",          // cell 的类名
                            TMessageCell_Data_Name : @"MSMesDongTaiData"   // cellData 的类名
                          },
                          @{BussinessID : @"custom_message_gift",  // 自定义消息唯一标识（注意不要重复）
                            TMessageCell_Name :  @"MSMesLiWuCell",          // cell 的类名
                            TMessageCell_Data_Name : @"MSMesLiWuData"   // cellData 的类名
                          },
                          @{BussinessID : @"custom_message_biaoqing",  // 自定义消息唯一标识（注意不要重复）
                            TMessageCell_Name :  @"MSMesBiaoQingCell",          // cell 的类名
                            TMessageCell_Data_Name : @"MSMesBiaoQingData"   // cellData 的类名
                          },
                          @{BussinessID : @"custom_message_mingpian",  // 自定义消息唯一标识（注意不要重复）
                            TMessageCell_Name :  @"MSMesMingPianTCell",          // cell 的类名
                            TMessageCell_Data_Name : @"MSMesMingPianCellData"   // cellData 的类名
                          },
                          @{BussinessID : @"custom_message_pipei",  // 自定义消息唯一标识（注意不要重复）
                            TMessageCell_Name :  @"MSMesMatchTCell",          // cell 的类名
                            TMessageCell_Data_Name : @"MSMesMatchCellData"   // cellData 的类名
                          },
                          @{BussinessID : @"custom_message_shareroom",  // 自定义消息唯一标识（注意不要重复）
                            TMessageCell_Name :  @"MSMesShareRoomTCell",          // cell 的类名
                            TMessageCell_Data_Name : @"MSMesShareRoomCellData"   // cellData 的类名
                          }
    ];
}
