...
- (id)init
{
    ...
    if(self){
        ...
        _defaultAvatarImage = TUICoreBundleThemeImage(@"default_c2c_head_img", @"CUYuYinFang_login_logo");
...
- (void)onChangeTheme
{
    self.defaultAvatarImage = TUICoreBundleThemeImage(@"default_c2c_head_img", @"CUYuYinFang_login_logo");
