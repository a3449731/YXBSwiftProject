...
@interface YXBSocketCenter ()<SRWebSocketDelegate>
...
@implementation YXBSocketCenter
...
- (void)setDelegate:(id<YXBSocketCenterDelegate>)delegate{
    _delegate = delegate;
...
- (void)sendPing:(NSData *)data timeInterval:(NSTimeInterval)interval{
    ...
    __weak YXBSocketCenter *weakSelf = self;
...
- (void)webSocket:(SRWebSocket *)webSocket didCloseWithCode:(NSInteger)code reason:(NSString *)reason wasClean:(BOOL)wasClean{
    ...
    if (self.closeBlock) {
        __weak YXBSocketCenter *weakSocket = nil;
