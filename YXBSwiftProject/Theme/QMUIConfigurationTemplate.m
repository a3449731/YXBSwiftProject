...
- (NSString *)themeName {
    return QMUIThemeManagerNameDefault;
}
...
- (void)commonConfig {
    if (!disclosureIndicatorImage) disclosureIndicatorImage = [UIImage qmui_imageWithShape:QMUIImageShapeDisclosureIndicator size:CGSizeMake(6, 10) lineWidth:1 tintColor:YXBColor_subText];
    if (!disclosureIndicatorImageDark) disclosureIndicatorImageDark = [UIImage qmui_imageWithShape:QMUIImageShapeDisclosureIndicator size:CGSizeMake(6, 10) lineWidth:1 tintColor:YXBColor_subText];
    //
    // === 修改配置值 === //
...
#pragma mark - Global Color
    ...
    QMUICMI.grayDarkenColor = [YXBThemeManager sharedInstance].subTextColor;                          // UIColorGrayDarken : 深一点的灰色
    ...
    QMUICMI.backgroundColor = [YXBThemeManager sharedInstance].backgroundColor;                                   // UIColorForBackground : 界面背景色，默认用于 QMUICommonViewController.view 的背景色
    ...
    QMUICMI.separatorColor = [YXBThemeManager sharedInstance].separatorColor;;                          // UIColorSeparator : 全局默认的分割线颜色，默认用于列表分隔线颜色、UIView (QMUI_Border) 分隔线颜色
    QMUICMI.separatorDashedColor = UIColorMake(17, 17, 17);                     // UIColorSeparatorDashed : 全局默认的虚线分隔线的颜色，默认 QMUIKit 暂时没用到
    QMUICMI.placeholderColor = [YXBThemeManager sharedInstance].placeholderColor;                                    // UIColorPlaceholder，全局的输入框的 placeholder 颜色，默认用于 QMUITextField、QMUITextView，不影响系统 UIKit 的输入框
...
#pragma mark - UIButton
    ...
    QMUICMI.buttonTintColor = [YXBThemeManager sharedInstance].tintColor;                              // ButtonTintColor : QMUIButton 默认的 tintColor，不影响系统的 UIButton
...
#pragma mark - TextInput
    //    QMUICMI.textFieldTextColor = [YXBThemeManager sharedInstance].titleTextColor;                     // TextFieldTextColor : QMUITextField、QMUITextView 的 textColor，不影响 UIKit 的输入框
    QMUICMI.textFieldTintColor = [YXBThemeManager sharedInstance].titleTextColor;                          // TextFieldTintColor : QMUITextField、QMUITextView 的 tintColor，不影响 UIKit 的输入框
...
#pragma mark - UISwitch
    QMUICMI.switchOnTintColor = [YXBThemeManager sharedInstance].tintColor;                           // SwitchOnTintColor : UISwitch 打开时的背景色（除了圆点外的其他颜色）
    //    QMUICMI.switchOffTintColor =  [YXBThemeManager sharedInstance].separatorColor;                    // SwitchOffTintColor : UISwitch 关闭时的背景色（除了圆点外的其他颜色）
...
#pragma mark - TabBar
    ...
    QMUICMI.tabBarItemTitleColor = YXBColor_subText_light;             // TabBarItemTitleColor : 未选中的 UITabBarItem 的标题颜色
    QMUICMI.tabBarItemTitleColorSelected = YXBColor_descriptionText_light;                // TabBarItemTitleColorSelected : 选中的 UITabBarItem 的标题颜色
...
#pragma mark - Toolbar
    ...
    QMUICMI.toolBarTintColor = [YXBThemeManager sharedInstance].tintColor;                            // ToolBarTintColor : UIToolbar 的 tintColor，以及 QMUIToolbarButton normal 状态下的文字颜色
...
#pragma mark - SearchBar
    ...
    QMUICMI.searchBarTintColor = [YXBThemeManager sharedInstance].tintColor;                          // SearchBarTintColor : QMUISearchBar 的 tintColor，也即上面的操作控件的主题色
    QMUICMI.searchBarTextColor = [YXBThemeManager sharedInstance].titleTextColor;                                  // SearchBarTextColor : QMUISearchBar 里的文本框的文字颜色
    QMUICMI.searchBarPlaceholderColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<YXBThemeProtocol> *theme) {
        if ([identifier isEqualToString:YXBThemeIndetifierDark]) {
...
#pragma mark - TableView / TableViewCell
    ...
    QMUICMI.tableViewBackgroundColor = YXBColor_background;                    // TableViewBackgroundColor : Plain 类型的 QMUITableView 的背景色颜色
    ...
    QMUICMI.tableViewCellTitleLabelColor = [YXBThemeManager sharedInstance].titleTextColor;             // TableViewCellTitleLabelColor : QMUITableViewCell 的 textLabel 的文字颜色
    QMUICMI.tableViewCellDetailLabelColor = [YXBThemeManager sharedInstance].descriptionTextColor;     // TableViewCellDetailLabelColor : QMUITableViewCell 的 detailTextLabel 的文字颜色
    QMUICMI.tableViewCellBackgroundColor = UIColorForBackground;                 // TableViewCellBackgroundColor : QMUITableViewCell 的背景色
    QMUICMI.tableViewCellSelectedBackgroundColor = [YXBThemeManager sharedInstance].backgroundColor_HighLight;  // TableViewCellSelectedBackgroundColor : QMUITableViewCell 点击时的背景色
    ...
    QMUICMI.tableViewCellDisclosureIndicatorImage = [UIImage qmui_imageWithThemeProvider:^UIImage * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<YXBThemeProtocol> * _Nullable theme) {
        return [identifier isEqualToString:YXBThemeIndetifierDark] ? disclosureIndicatorImageDark : disclosureIndicatorImage;
    ...
    QMUICMI.tableViewCellCheckmarkImage = [UIImage qmui_imageWithShape:QMUIImageShapeCheckmark size:CGSizeMake(15, 12) tintColor:[YXBThemeManager sharedInstance].tintColor];  // TableViewCellCheckmarkImage : QMUITableViewCell 当 accessoryType 为 UITableViewCellAccessoryCheckmark 时的打钩的图片
    QMUICMI.tableViewCellDetailButtonImage = [UIImage qmui_imageWithShape:QMUIImageShapeDetailButtonImage size:CGSizeMake(20, 20) tintColor:[YXBThemeManager sharedInstance].tintColor]; // TableViewCellDetailButtonImage : QMUITableViewCell 当 accessoryType 为 UITableViewCellAccessoryDetailButton 或 UITableViewCellAccessoryDetailDisclosureButton 时右边的 i 按钮图片
    ...
    QMUICMI.tableViewSectionHeaderBackgroundColor = QMUICMI.tableViewBackgroundColor;                         // TableViewSectionHeaderBackgroundColor : Plain 类型的 QMUITableView sectionHeader 的背景色
    QMUICMI.tableViewSectionFooterBackgroundColor = QMUICMI.tableViewBackgroundColor;                         // TableViewSectionFooterBackgroundColor : Plain 类型的 QMUITableView sectionFooter 的背景色
    ...
    QMUICMI.tableViewGroupedBackgroundColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<YXBThemeProtocol> * _Nullable theme) {
        if ([identifier isEqualToString:YXBThemeIndetifierDark]) {
    ...
    QMUICMI.tableViewGroupedCellBackgroundColor =[YXBThemeManager sharedInstance].subTextColor;                         // TableViewGroupedCellBackgroundColor : Grouped 类型的 QMUITableView cell 背景色
...
//    QMUICMI.tableViewGroupedSectionHeaderDefaultHeight = UITableViewAutomaticDimension;                 // TableViewGroupedSectionHeaderDefaultHeight : Grouped 类型的 QMUITableView sectionHeader 的默认高度（也即没使用自定义的 sectionHeaderView 时的高度），注意如果不需要间距，请用 CGFLOAT_MIN
    QMUICMI.tableViewGroupedSectionHeaderDefaultHeight = CGFLOAT_MIN;
//    QMUICMI.tableViewGroupedSectionFooterDefaultHeight = UITableViewAutomaticDimension;                 // TableViewGroupedSectionFooterDefaultHeight : Grouped 类型的 QMUITableView sectionFooter 的默认高度（也即没使用自定义的 sectionFooterView 时的高度），注意如果不需要间距，请用 CGFLOAT_MIN
    QMUICMI.tableViewGroupedSectionFooterDefaultHeight = CGFLOAT_MIN;
